...
`map` returns a new array of elements after passing each element back to the callback. `.forEach` returns `undefined`.

2. What is the difference between a function and a method?

A function is a piece of code that is run when called by other code or by itself. A function can be put within a variable.

A method is a function that is a property of an object.

3. What is closure?

A closure is a function and the lexical environment within which that function was declared.
